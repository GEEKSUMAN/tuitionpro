												...
												<div class="user-wrap wideget-user-info">
													...
													<div class="wideget-user-rating">
														<div class="rating-stars">
															<?php if(count($reviews)>0 && is_array($reviews)){$average = ceil( array_sum(array_column($reviews,'rating_star_value')) / count($reviews) );} else{$average=0;}?>
								...
								<div class="wideget-user-tab">
									<div class="tab-menu-heading">
										<div class="tabs-menu1">
											<ul class="nav">
												<li class=""><a href="#tab-5" class="active" data-toggle="tab">Tutorial Details</a></li>
									...
									<div class="tab-content">
										<div class="tab-pane active" id="tab-5">
											<div class="profile-log-switch">
												<div><span class="text-dark h4">Short Description : </span><?php echo $tutorial['sub_title']; ?></div>
												<div><span class="text-dark h4">Description : </span><?php echo $tutorial['description']; ?></div>
												<div><span class="text-dark h4">Prerequisites : </span><?php echo $tutorial['prerequisite']; ?></div>
												<div><span class="text-dark h4">Category : </span><?php echo $tutorial['category']; ?></div>
												<div><span class="text-dark h4">Board : </span><?php echo $tutorial['boards']; ?></div>
												<div><span class="text-dark h4">Class : </span><?php echo $tutorial['classes']; ?></div>
												<div><span class="text-dark h4">Subject : </span><?php echo $tutorial['subject']; ?></div>
												<div><span class="text-dark h5">Level : </span><?php echo $tutorial['level']; ?></div>
