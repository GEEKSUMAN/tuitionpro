					...
					<div class="col-xl-3 col-lg-12 col-md-12">
						<div class="card">
							...
							<div class="item1-links  mb-0">
								...
								<a href="<?php echo base_url('dashboard/enroll-students') ?>" class=" active d-flex  border-bottom">
							...
							<div class="card-body">
								<table class="table table-bordered table-hover mb-0 text-nowrap">
												...
												<tbody>
													...
													<tr>
														<td>
															<?php echo get_tutorial_title($enroll_detail['tutorials_id']);?>
														</td>
														<td><?php echo get_full_name($enroll_detail['student_id']);?></td>
														<td> <?php echo get_user_email($enroll_detail['student_id']);?></td>
