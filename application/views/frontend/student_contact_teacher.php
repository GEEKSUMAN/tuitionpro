								...
								<table class="table table-bordered table-hover mb-0 text-nowrap">
												<thead>
													<tr class="bg-success">
														...
														<th class="text-white">Teacher Email</th>
												...
												<tbody>
													...
													<tr>
														<td><?php echo get_full_name($enroll_detail['teacher_user_id']);?></td>
														<td> <?php echo get_user_email($enroll_detail['teacher_user_id']);?></td>
