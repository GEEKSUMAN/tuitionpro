											...
											<table id="example" class=" table table-striped table-bordered">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<a class="btn btn-success edit-about btn-sm text-white" data-toggle="modal" data-target="#exampleModal3" data-id="<?php echo $about['about_us_id'];?>" data-title="<?php echo $about['title'];?>" data-description="<?php echo htmlentities($about['description']);?>" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
															<a  data-link="<?php echo base_url('admin/about-us/delete/').$about['about_us_id'];?>" class="delete btn btn-danger btn-sm text-white" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
														</td>
													</tr>
													<?php } ?>
												</tbody>
			...
			<div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog"  aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form action="<?php echo base_url('admin/about-us/edit'); ?>" method="post">
						<div class="modal-body">
								...
								<input type="hidden" name="edit_about_us_id" id="edit_about_us_id" >
			...
			<div class="modal fade" id="exampleModal4" tabindex="-1" role="dialog"  aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form action="<?php echo base_url('admin/about-us/add'); ?>" method="post">
						<div class="modal-body">
